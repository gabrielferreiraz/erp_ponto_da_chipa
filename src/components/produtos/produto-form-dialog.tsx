    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-xl">
        <DialogHeader>
          ...
          <DialogDescription className="text-sm text-zinc-500 font-medium pt-1">
            {isEditing 
        ...
        <form onSubmit={handleSubmit(onSubmit, onError)} className="space-y-5 mt-2">
          {/* ── SEÇÃO 1: Identidade & Comercial ── */}
          <div className="p-5 bg-zinc-50/50 border border-zinc-100 rounded-2xl space-y-4">
            <h3 className="text-[11px] font-black text-zinc-400 uppercase tracking-widest mb-2">Identidade & Preço</h3>
          ...
          <div className="p-5 bg-zinc-50/50 border border-zinc-100 rounded-2xl space-y-4">
             <h3 className="text-[11px] font-black text-zinc-400 uppercase tracking-widest mb-2">Saldos de Estoque</h3>
          ...
          <div className="p-5 bg-zinc-50/50 border border-zinc-100 rounded-2xl space-y-5">
            <h3 className="text-[11px] font-black text-zinc-400 uppercase tracking-widest">Publicação</h3>
