...
async function main() {
  ...
  console.log('✅ Categorias criadas:', { categoriaChipas, categoriaBebidas, categoriaExtras })

  // Criar produtos iniciais
  const produtoChipaSimples = await prisma.produto.upsert({
  ...
  const produtoChipaQueijo = await prisma.produto.upsert({
  ...
  const produtoRefri = await prisma.produto.upsert({
  ...
  console.log('✅ Produtos criados:', { produtoChipaSimples, produtoChipaQueijo, produtoRefri })
  ...
  console.log('✅ Usuário ADMIN criado:', { id: admin.id, email: admin.email, role: admin.role })
  ...
  console.log('✅ Usuário CAIXA de exemplo criado:', { id: caixa.id, email: caixa.email })
  ...
  console.log('✅ Usuário ATENDENTE de exemplo criado:', { id: atendente.id, email: atendente.email })
